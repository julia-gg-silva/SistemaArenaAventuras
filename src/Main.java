...
public class Main {
    ...
    public static void menu(){
        ...
        switch(opcao){
            case 1: menuGerenciarHerois();
                break;
            case 2: menuGerenciarDesafios();
                break;
            case 3:  menuParticiparDesafios();
                break;
    ...
    private static void menuRelatorios() {
        ...
        switch(opcao){
            case 1: listarHerois();
                break;
            case 2: listarDesafios();
                break;
            case 3: buscarHeroi();
                break;
            case 4 : exibirInventario();
                break;
            case 5: agruparPorNivel();
                break;
            case 6: agruparDesafioPorDificuldade();
                break;
            case 7:
                break;
            default :
    ...
    private static void menuParticiparDesafios() {
        ...
        int opcao = sc.nextInt();
        switch(opcao){
            case 1: addHeroiADesafio();
                break;
            case 2: removerHeroiDeDesafio();
                break;
            case 3: iniciarDesafio();
                break;
            case 4 :
                break;
            default :
    ...
    private static void menuGerenciarDesafios() {
        ...
        switch(opcao){
            case 1: criarDesafio();
                break;
            case 2: atualizarDesafio();
                break;
            case 3: removerDesafio();
                break;
            case 4 :
                break;
            default :
